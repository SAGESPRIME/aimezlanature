 ...
 *
 * Un slug absent d'ici (ex. pack-35-perles, encore sans photo) retombe
 * automatiquement sur le visuel de substitution et voit son champ `image`
 * omis du schema, plutôt que de pointer vers une URL 404.
 */
